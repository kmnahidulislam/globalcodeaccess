...
import { Globe, Eye, Target, Heart, ArrowRight } from 'lucide-react';
      ...
      <Section>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {[
            {
              stat: '~3 Billion',
              label: 'People remain offline worldwide, excluded from the digital economy and its opportunities.',
            },
            {
              stat: '60%+',
              label: 'Of the population in least developed countries lacks internet access, limiting exposure to technology.',
            },
            {
              stat: '< 5%',
              label: 'Of people in low-income countries have basic digital skills, creating a massive participation gap.',
            },
          ].map((item, idx) => (
